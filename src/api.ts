...
export type Feature = { mainStem?: { status: string; limitations?: string[] }; recordedNetwork?: { geometry: GeoJSON.Geometry; bbox: [number, number, number, number]; lengthKm: number; recordCount: number }; identity?: unknown; selection?: unknown; id: string; name: string; type: string; geometry: GeoJSON.Geometry; bbox: [number, number, number, number]; status: string; lengthKm: number | null; areaKm2: number | null; confidence: string; method: string; algorithmVersion: string; warnings: string[]; created: string; evidence: { sourceId: string; sourceName: string; sourceUrl: string; licence: string; attribution: string; objectId: string; importId: string; checksum: string; sourceVersion: string }[] };
