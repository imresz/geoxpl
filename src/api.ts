...
export const statusLabel = (s: string) => ({ pending: 'Pending', resolved: 'Resolved', partially_resolved: 'Partially resolved', missing_capability: 'Needs capability', insufficient_data: 'Insufficient data', awaiting_review: 'Awaiting review', queued: 'Queued', processing: 'Processing', failed: 'Failed', approved: 'Approved', rejected: 'Rejected' }[s] || s.replaceAll('_', ' '));
